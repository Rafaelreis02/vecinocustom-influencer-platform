  ...
  return (
    <div className="space-y-6">
      <div className="text-sm text-gray-600 bg-blue-50 p-4 rounded-lg border border-blue-100">
        <p className="font-medium text-blue-800 mb-1">🧠 Descoberta Simplificada</p>
        <p>Insere uma conta seed do TikTok e a IA vai encontrar influencers similares a seguir.</p>
      </div>

      {/* Seed (OBRIGATÓRIA) */}
      <div>
        <label className="block text-sm font-semibold text-gray-700 mb-2">
          Seed do TikTok * <span className="text-red-500">(obrigatório)</span>
        </label>
      ...
      <div>
        <label className="block text-sm font-semibold text-gray-700 mb-2">
          Máximo de influencers: <span className="text-blue-600 text-lg font-bold">{max}</span>
        </label>
        <input
          type="range"
          min="5"
